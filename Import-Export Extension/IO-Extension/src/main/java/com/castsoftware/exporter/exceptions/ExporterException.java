...
/**
 * The <code>MoiraiException</code> is the based Exception class of the Moirai procedure.
 ...
 * MoiraiException
 */
public abstract class ExporterException extends Throwable {

    private static final long serialVersionUID = -8579984202435983804L;
    private static final Pattern errorCodeReg = Pattern.compile("^[\\w\\d]{3}_[\\w\\d]{2,3}_[\\w\\d]{8,10}$",
            Pattern.CASE_INSENSITIVE);
    protected String code;

    public ExporterException(String message, Throwable cause, String code) {
        super(message, cause);
    ...
    public ExporterException(String message, String code) {
        super(message);
